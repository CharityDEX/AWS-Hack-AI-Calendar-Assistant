  ...
  return (
    <div className='meeting-card'>
      ...
      <div className='title-container'>
        <label htmlFor='meeting-title' className='meeting-title-label'>Meeting Title</label>
        <input 
          id='meeting-title'
      ...
      <div className='duration-container'>
        <label htmlFor="duration" className='duration-container-label'>Duration (minutes)</label>
        <input
          type="number"
          id="duration"
          className='duration'
      ...
      <div className='participants-container'>
        <form className='participants-form'>
          ...
          />
          <button type='submit' onClick={addParticipant} className='hidden'>Add</button>
        </form>
      ...
      <div className='description-container'>
          <label htmlFor='description' className='description-label'>Meeting Description</label>
          <textarea 
            id='description'
      ...
      <button onClick={handleSubmit} className='form-submit-btn'>Schedule Meeting</button>
